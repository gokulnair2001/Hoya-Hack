...
class MedicineBotViewController: UIViewController {
    ...
    var searches:[String] = ["treat acne vulgaris","treatment of dry scaly skin disorders of the scalp","Mild to moderate acne (spots)","combined with anti-acne actives of both natural and synthetic origin","relief from itching","treat Acne which often refer to as pimples or spots"]
